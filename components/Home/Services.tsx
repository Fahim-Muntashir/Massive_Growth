export const Services = () => {
    return (
        <div className="bg-gradient-to-tr from-white via-white to-yellow-100 ">

            <div className="px-4bg-gradient-to-tr from-white via-white to-yellow-100  py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
