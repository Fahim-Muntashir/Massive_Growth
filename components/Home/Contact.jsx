              ...
              <div class=" lg:w-1/2 lg:mx-6">
                ...
                <div class="mt-6 md:mt-8">
                  ...
                  <div class="flex mt-4 -mx-1.5 ">
                    <a
                      class="mx-1.5  transition-colors duration-300 transform hover:text-blue-500"
                      href="#"
                    >
                      <svg
              ...
              <div class="mt-8 lg:w-1/2 lg:mx-6">
                <div class="w-full px-8 py-10 mx-auto overflow-hidden bg-white shadow-2xl rounded-xl dark:bg-gray-900 lg:max-w-xl">
                  ...
                  <form class="mt-4">
                    ...
                    <button class="w-full px-6 py-3 mt-6 text-sm tracking-wide  capitalize transition-colors duration-300 transform bg-primary text-white font-bold rounded-md hover:bg-blue-500 focus:outline-none focus:ring focus:ring-blue-400 focus:ring-opacity-50">
                      get in touch
                    </button>
                  </form>
                </div>
